...
function ParticleStory() {
  ...
  return <>
    ...
    <TraceViewer />
    <section className="film-section" id="film"><div className="film-heading"><span>02 · 영상 기록</span><h2>흔적을 넘어서 기억을 읽다</h2><p>제작 과정 영상이 준비되면 이 공간에 연결됩니다.</p></div><div className="film-frame"><div className="film-placeholder"><button aria-label="영상 재생 자리">▶</button><b>FILM PLACEHOLDER</b><span>16 : 9 · VIDEO</span></div></div></section>
  </>;
}
