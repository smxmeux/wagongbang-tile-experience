...
function TraceViewer() {
  ...
  useEffect(()=>{
    ...
    let alive=true,frame=0,yaw=-.18,pitch=.08,yawVelocity=0,dragging=false,userInteracted=false,lastX=0,lastY=0;
    ...
    const down=(event:globalThis.PointerEvent)=>{dragging=true;userInteracted=true;lastX=event.clientX;lastY=event.clientY;yawVelocity=0;target.setPointerCapture(event.pointerId)};
    ...
    const up=()=>{dragging=false;yawVelocity=0};
