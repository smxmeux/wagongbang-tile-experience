...
function TraceViewer() {
  ...
  useEffect(()=>{
    ...
    let alive=true,frame=0,yaw=-.18,pitch=.08,yawVelocity=0,dragging=false,userInteracted=false,lastX=0,lastY=0,markerDraggingIndex=-1,pinchDistance=0;
