...
function ParticleStory() {
  ...
  return <>
    ...
    <TraceViewer />
    <section className="film-section" id="film"><div className="film-heading"><span>02 · 영상 기록</span><h2>흔적을 넘어서 기억을 읽다</h2><p>기와에 남은 흔적을 디지털 기록과 해석으로 살펴봅니다.</p></div><div className="film-frame"><video controls autoPlay muted loop playsInline preload="metadata" src="/feature-film.mp4">이 브라우저에서는 영상을 재생할 수 없습니다.</video></div></section>
  </>;
}
